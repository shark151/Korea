  ...
  return (
    <div>
      ...
      <div className='space-y-4 text-2xl'>
        <div className='text-xl grid gap-4  grid-cols-2 lg:grid-cols-4'>
          <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
              <CardTitle className='text-xl font-xmedium'>
                {t('Total Revenue')}
              </CardTitle>
              <BadgeDollarSign />
            </CardHeader>
            <CardContent className='space-y-2'>
              <div className='text-2xl font-bold'>
                <ProductPrice price={data.totalSales}  />
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent className='space-y-2'>
              ...
              <div>
                <Link className='text-xm' href='/admin/users'>
                  {t('View customers')}
                </Link>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className='space-y-2'>
              ...
              <div>
                <Link className='text-xm' href='/admin/products'>
                  {t('View products')}
                </Link>
              </div>
            </CardContent>
