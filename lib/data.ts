...
const products: IProductInput[] = [
  {
    ...
    keywords: ['طقم' , 'أطقم' , 'جرانيت', 'حلل' , 'نيوفلام' , 'تركي'],
...
//===============================================================    
    {
      ...
      content: `في " Korea " نحرص على راحتك وتقديم تجربة تسوق سهلة وآمنة عند شراء المنتجات. فريق خدمة العملاء لدينا جاهز لمساعدتك في أي استفسار يخص الطلبات، التوصيل، أو سياسة الاستبدال والاسترجاع..

  طرق التواصل معنا:

📧 البريد الإلكتروني: support@Korea.com
...
لطلب الاسترجاع أو الاستبدال، يُرجى التواصل مع خدمة العملاء علي رقم 01203452701.`,
...
[ Shark ] — نساعدك على بيع أكثر والوصول لأفضل العملاء.`,
    ...
    },
    {
      ...
      slug: 'shipping',
      content: `نشكركم على التسوق من متجرنا. نسعى دائمًا لتوفير خدمة شحن سريعة وآمنة لجميع عملائنا داخل جمهورية مصر العربية.

نطاق الشحن

نقوم حاليًا بالشحن إلى جميع محافظات جمهورية مصر العربية.

رسوم الشحن

يتم احتساب رسوم الشحن وفقًا لموقع العميل وحجم الطلب.

القاهرة والجيزة: تبدأ من 50 جنيه مصري.

محافظات الدلتا: تبدأ من 60 جنيه مصري.

محافظات الصعيد والمناطق البعيدة: تبدأ من 80 جنيه مصري.

سيتم عرض تكلفة الشحن النهائية أثناء إتمام عملية الشراء قبل تأكيد الطلب.

مدة تجهيز الطلبات

يتم تجهيز الطلبات خلال 1 إلى 2 يوم عمل من تاريخ تأكيد الطلب.

مدة التوصيل المتوقعة

القاهرة والجيزة: من 1 إلى 3 أيام عمل.

محافظات الدلتا: من 2 إلى 5 أيام عمل.

محافظات الصعيد والمناطق البعيدة: من 3 إلى 7 أيام عمل.

قد تختلف مواعيد التسليم خلال المواسم والعطلات الرسمية أو بسبب ظروف خارجة عن إرادتنا.

تتبع الطلبات

سيتم إرسال بيانات الشحنة أو رقم التتبع للعميل عند توفره من خلال شركة الشحن.

تعذر التسليم

في حال تعذر تسليم الطلب بسبب إدخال بيانات غير صحيحة أو عدم إمكانية التواصل مع العميل، قد يتم تطبيق رسوم شحن إضافية لإعادة إرسال الطلب.

المنتجات التالفة أو الناقصة

في حال استلام منتج تالف أو وجود نقص في الطلب، يرجى التواصل مع خدمة العملاء خلال 48 ساعة من استلام الشحنة.

التواصل معنا

لأي استفسارات متعلقة بالشحن أو التوصيل، يرجى التواصل مع فريق خدمة العملاء عبر صفحة "اتصل بنا".

[ Korea ] تلتزم بتوفير أفضل تجربة تسوق ممكنة, ونشكركم علي ثقتكم بنا.`,
      isPublished: true,
    },
  ],
  headerMenus: [
  ...
  settings: [
    {
      ...
      site: {
        ...
        email: 'admin@example.com',
        address: 'Mit Kholi Abdallah, Damietta, Egypt',
        phone: '01203452701',
      },
      carousels: [
    {
